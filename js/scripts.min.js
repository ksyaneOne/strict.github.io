...
$(document).ready(function(){$(".s-header").css("min-height",$(window).height()),$(".preloader").fadeOut(),$(".popup_content").magnificPopup({type:"inline"}),$(".s-header__title-heading").animated("fadeInDown","fadeOutUp"),$(".s-header__title-text, .s-features__title-heading, .s-features__title-text, .s-features__items, .s-works__title, .s-contact__title, .s-contact__form").animated("fadeInUp","fadeOutDown"),$(".separator-blue").animated("fadeIn","fadeOut")});